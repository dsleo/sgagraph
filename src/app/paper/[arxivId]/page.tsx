...
import { injectMathJaxMacros, typesetMath } from '@/components/constellations/mathjax';
...
export default function PaperPage() {
    ...
    const latexMacrosRef = useRef<Record<string, string | [string, number]>>({});
                ...
                while (!cancelled) {
                    ...
                    for (const json of events) {
                        if (json.type === 'status') {
                            ...
                            const m = (json.data ?? {}) as Record<string, string | [string, number]>;
